...
kappa_needed = 1.5 / T_1H

params = ACParams(
    S0=S0, sigma=sigma, mu=0.0, X0=100.0,
    T=T_1H, N=50, gamma=1.48, eta=eta,
    alpha=1.0, lam=LAM,
)
...
# --- 10k paths ---
Z_10k = generate_normal_increments(10000, params.N, method="pseudo", seed=SEED)
...
# --- 100k paths ---
Z_100k = generate_normal_increments(100000, params.N, method="pseudo", seed=SEED)
